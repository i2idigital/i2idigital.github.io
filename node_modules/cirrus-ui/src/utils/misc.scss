...
@if should-generate-classes($FLOAT) {
    ...
    @include utility(
        $class-value-pairs: class-value-map-with-single-property('float', to-property-map($pull-directions)),
        $common-class-name: 'pull',
        $variants: (),
...
@if should-generate-classes($TEXT) {
    ...
    @include utility(
        $class-value-pairs: class-value-map-with-single-property('text-align', to-property-map($text-directions)),
        $common-class-name: 'text',
        $variants: (),
        $generate-viewports: #{get-viewport-flag($TEXT)},
        $override: '!important'
    );
}
